...
from .localrnn import LocalRNNBlock
...
def process_data(data):
    ...
    for key in data.keys:
        if  key =="code_seq" or key =="nl" :#or key =="node_max":
            continue
...
class BaseDecoder(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask,
                ...
                memory_key_padding_mask=None,g_encoder=None):
        output = tgt
        ...
        for mod in self.layers:
            output, attn_weights = mod(output, memory, tgt_mask=tgt_mask,
                                       ...
                                       memory_key_padding_mask=memory_key_padding_mask,g_encoder=g_encoder)
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask=None, memory_mask=None,
                tgt_key_padding_mask=None, memory_key_padding_mask=None,g_encoder=None):
